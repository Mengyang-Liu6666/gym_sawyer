...
from gym_sawyer.task_envs.sawyer_env_discrete import SawyerEnvDiscrete
...
register(
        ...
        entry_point='gym_sawyer.task_envs.sawyer.learn_to_touch_cube:SawyerTouchCubeEnv',
        max_episode_steps=timestep_limit_per_episode,
    )

class SawyerTouchCubeEnv(SawyerEnvDiscrete):
    def __init__(self):
        """
  ...
  right_j2, right_j3, right_j4, right_j5, right_j6
    ...
    def _set_action(self, action):
        ...
        # Gripper actions
        elif action == 14: # Gripper open
            action_id = "gripper_open"
        elif action == 15: # Gripper close
            action_id = "gripper_close"
        # elif action == 16: # Gripper calibrate
            # action_id = "gripper_calibrate"
  ...
  right_j2, right_j3, right_j4, right_j5, right_j6
        ...
        joints_angles_array = list(self.get_all_limb_joint_angles().values())
