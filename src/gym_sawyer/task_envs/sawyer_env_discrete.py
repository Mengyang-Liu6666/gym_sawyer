...
class SawyerEnvDiscrete(RobotGazeboEnv):
    """Superclass for all SawyerEnvDiscrete environments.
    """

    def __init__(self):
        """
        Initializes a new SawyerEnvDiscrete environment.
        ...
        * As actuator we will use a class to interface with the movements through commands.
        ...
        Args:
        """
        rospy.logdebug("Start SawyerEnvDiscrete INIT...")
        ...
        super(SawyerEnvDiscrete, self).__init__(controllers_list=self.controllers_list,
        ...
        rospy.logdebug("SawyerEnvDiscrete unpause...")
        ...
        rospy.logdebug("Finished SawyerEnvDiscrete INIT...")
    ...
    def _check_all_systems_ready(self):
        ...
        operational.
        """
        rospy.logdebug("SawyerEnvDiscrete check_all_systems_ready...")
        self._check_all_sensors_ready()
        rospy.logdebug("END SawyerEnvDiscrete _check_all_systems_ready...")
        return True
    ...
    def _map_actions_to_movement(self, side="right", joint_delta=0.1):
        ...
        if self.has_gripper:
            ...
            "gripper_close": (self.set_g, "close", side+" gripper close"),
            "gripper_open": (self.set_g, "open", side+" gripper open"),
            "gripper_calibrate": (self.set_g, "calibrate", side+" gripper calibrate")
            })
