...
from gym_sawyer.task_envs.gazebo_connection import GazeboConnection
from gym_sawyer.task_envs.controllers_connection import ControllersConnection
from gym_sawyer.msg import RLExperimentInfo
...
class RobotGazeboEnv(gym.Env):
    ...
    def step(self, action):
        ...
        # To support HER
        info = self._get_info(done, self.init_obs, self.last_obs)
