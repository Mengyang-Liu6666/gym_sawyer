#!/usr/bin/env python3
import gym
from task_envs_list import Register_Ros_Env
import roslaunch
import rospy
import rospkg
...
def Start_ROS_Environment(task_and_robot_environment_name):
    """
    ...
    result = Register_Ros_Env(task_env=task_and_robot_environment_name,
